...
export default function BrowsePage({ onSelectVideo, chainVideos = [] }) {
  ...
  // Only use real videos loaded from the smart contract.
  // Do NOT fall back to mock videos, because mock IDs do not exist on-chain.
  const source = chainVideos;
    ...
    <div style={styles.page}>
      <div style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          <div style={styles.heroBadge}>
            ...
            {chainVideos.length > 0 ? "Live on Ethereum" : "No on-chain videos yet"}
          </div>
      ...
      <div style={styles.statsBar}>
        <span style={styles.statsText}>
          ...
          {chainVideos.length > 0 && (
            <span style={styles.liveTag}> · live on-chain</span>
          )}
        </span>
      ...
      {filtered.length === 0 ? (
        <div style={styles.empty}>
          ...
          <p style={styles.emptyText}>No on-chain videos found</p>
          <p style={styles.emptySubtext}>
            Go to Dashboard and upload/register a video first.
          </p>
        </div>
      ) : (
